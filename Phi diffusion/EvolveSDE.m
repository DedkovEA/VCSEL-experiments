function [time, Qp, Qm, psi, G, d] = EvolveSDE(T, Dt, Qp0, Qm0, psi0, G0, d0, gamma, kappa, alpha, gamma_d, gamma_p, gamma_a, mu, C_sp, N_th, N_tr)
%EVOLVESDE Performs Euler-Maruyama scheme on VCSEL equations
