...
\begin{gather}
	...
	\begin{aligned}
		...
		%\frac{(\gamma_a+\kappa ) \left(\gp  \gamma_a (\alpha  \gamma_p+\kappa )+\gamma_p (\alpha  \gp  \kappa -\gp  \gamma_p+\gamma_d \gamma_p)+\gamma_a^2 \gamma_d\right)}{\gp  \kappa  \left(\alpha  \gamma_p (\gamma_a+\kappa )+\gamma_a \kappa -\gamma_p^2\right)}
	\end{aligned}
	\right.\\
...
%\begin{equation}
%	\mu \lessgtr \frac{(\gamma_a+\kappa ) \left(\alpha\gp  \gamma_p(\gamma_a + \kappa) + \gp\gamma_a\kappa - \gp\gamma_p^2 + \gamma_d(\gamma_p^2 + \gamma_a^2)\right)}
%	{\gp  \kappa  \left(\gamma_a (\alpha  \gamma_p  + \kappa)+ \gamma_p (\alpha\kappa -\gamma_p)\right)}
%\end{equation}
